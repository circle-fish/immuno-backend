...
//import com.kingmed.kmhrg.domain.vo.LoginUser;
...
//            return false;
//        }
//        LoginUser user = getLoginUserFromToken(token);
//        if (user == null) {
//            return false;
//        }
//        refreshToken(user);
...
//    }
//
//    public String createTestToken(LoginUser user) {
//        // Jwt存储信息
//        Map<String, Object> claims = new HashMap<>();
...
//        user.setExpireTime(user.getLoginTime() + EXPIRE_TIME);
//        // 根据uuid将loginUser缓存
